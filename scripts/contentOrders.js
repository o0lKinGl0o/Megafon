...
newRow.innerHTML = `
    ...
    <td><input type="text" class="nameEmployeeRec" value="" id="nameEmployeeRec"></td> 
    <td>
    ...
    <td id="delColRec" class="hide"><button type="button" id="delColButRec" onclick="delCol(this.value, 'заказы', 'Код_заказа')" value="">Удалить</button></td>
    <td><button type="button" id="orderList" onclick="orderList()" value="">Состав заказа</button></td> 
  `;
const pK='Код_заказа';
...
const inputsFilter={
    ...
    'search-input-nameEmployee': 'nameEmployeeRec'
};
filter(inputsFilter);
